...
public class Weatherinfo {
	...
	private String week;
	@Expose
	private String fchh;// Âá†ÁÇπÊõ¥Êñ∞ÁöÑÊï∞Êç?
	@Expose
	...
	public void setWind1(String wind1) {
		if (wind1.contains("ËΩ?")) {
			String[] strs = wind1.split("ËΩ?");
			wind1 = strs[0];
		}
		this.wind1 = wind1;
	}
	...
	public void setWind2(String wind2) {
		if (wind2.contains("ËΩ?")) {
			String[] strs = wind2.split("ËΩ?");
			wind2 = strs[0];
		}
		this.wind2 = wind2;
	}
	...
	public void setWind3(String wind3) {
		if (wind3.contains("ËΩ?")) {
			String[] strs = wind3.split("ËΩ?");
			wind3 = strs[0];
		}
		this.wind3 = wind3;
	}
	...
	public void setWind4(String wind4) {
		if (wind4.contains("ËΩ?")) {
			String[] strs = wind4.split("ËΩ?");
			wind4 = strs[0];
		}
		this.wind4 = wind4;
	}
	...
	public void setWind5(String wind5) {
		if (wind5.contains("ËΩ?")) {
			String[] strs = wind5.split("ËΩ?");
			wind5 = strs[0];
		}
		this.wind5 = wind5;
	}
	...
	public void setWind6(String wind6) {
		if (wind6.contains("ËΩ?")) {
			String[] strs = wind6.split("ËΩ?");
			wind6 = strs[0];
		}
		this.wind6 = wind6;
	}
