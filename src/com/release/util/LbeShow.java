...
public class LbeShow extends Activity {
	public LocationClient mLocationClient = null;
	public BDLocationListener myListener = new MyLocationListener();

	public List now_lbe(final Context c, final MapView mMapView) {
		...
		mLocationClient.registerLocationListener(new BDLocationListener() {
			...
			public void onReceiveLocation(BDLocation location) {
				...
				switch (errorcode) {
				case 61:
					Toast.makeText(c, "GPS定位成功:"+location.getCity(), Toast.LENGTH_SHORT).show();
				...
				case 65:
					// 定位缓存
					Toast.makeText(c, "定位成功:"+location.getCity(), Toast.LENGTH_SHORT).show();
					break;
				case 161:
					Toast.makeText(c, "网络定位成功:"+location.getCity(), Toast.LENGTH_SHORT).show();
					break;
				default:
